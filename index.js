...
gsap.from(".banner", { opacity: 0, duration: 1, delay: 1.25, x: -200 })
gsap.from(".hero h3", { opacity: 0, duration: 1, delay: 1.5, y: -50 })
gsap.from(".hero h1", { opacity: 0, duration: 1, delay: 1.75, y: -45 })
gsap.from(".hero h4", { opacity: 0, duration: 1, delay: 2, y: -30 })
gsap.from(".hero a", { opacity: 0, duration: 1, delay: 2.25, y: 50 })
gsap.from(".nav-item", { opacity: 0, duration: .5, delay: 1.2, y: 30, stagger: 0.2 })
gsap.from(".icons", { opacity: 0, duration: 1, delay: 2.25, y: -50 })
